...
Public Class FormProdPlan2
    ...
    Private Sub DataGridView1_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellDoubleClick
        FormWorksheetPrint.TextBox2.Text = Me.DataGridView1.SelectedCells(2).Value.ToString ' wo supply
        FormWorksheetPrint.TextBox1.Text = Me.DataGridView1.SelectedCells(4).Value.ToString ' pn
        FormWorksheetPrint.TextBox4.Text = Me.DataGridView1.SelectedCells(7).Value.ToString ' qty
        Me.Close()
        FormWorksheetPrint.DataGridView1.DataSource = Nothing
        FormWorksheetPrint.DataGridView1.Rows.Clear()
        FormWorksheetPrint.DataGridView2.DataSource = Nothing
        FormWorksheetPrint.DataGridView2.Rows.Clear()
        FormWorksheetPrint.GroupBox1.Enabled = True

        FormWorksheetPrint.RadioButton2.Checked = False
        FormWorksheetPrint.RadioButton1.Checked = True
        FormWorksheetPrint.TextBox3.Text = ""
    End Sub

    Private Sub DataGridView2_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView2.CellDoubleClick
        FormWorksheetPrint.TextBox1.Text = Me.DataGridView2.SelectedCells(0).Value.ToString ' pn
        FormWorksheetPrint.TextBox3.Text = Me.DataGridView2.SelectedCells(3).Value.ToString ' wo demand
        FormWorksheetPrint.TextBox4.Text = Me.DataGridView2.SelectedCells(6).Value.ToString ' qty
        Me.Close()
        FormWorksheetPrint.DataGridView1.DataSource = Nothing
        FormWorksheetPrint.DataGridView1.Rows.Clear()
        FormWorksheetPrint.DataGridView2.DataSource = Nothing
        ...
        FormWorksheetPrint.RadioButton1.Checked = False
        FormWorksheetPrint.RadioButton2.Checked = True
        FormWorksheetPrint.TextBox2.Text = ""
    End Sub
