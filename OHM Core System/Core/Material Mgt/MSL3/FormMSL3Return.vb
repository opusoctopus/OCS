...
Public Class FormMSL3Return
    ...
    Private Sub FormMSL3Return_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'Call Bersih()
        'Call LoadData()
            ...
            For Baris As Integer = 0 To FormMSL3MGT.DataGridView1.Rows.Count - 1
                ...
                Try
                    If rd.HasRows Then
                        Dim sql As String
                        rd.Close()
                        sql = "UPDATE prodsys2_msl3_transaction_log_tbl SET line = @line WHERE txn_id = @txn_id"
                        cmd.Connection = conn
                        cmd.CommandText = sql
