...
Public Class FormNozzleCam
    ...
    Private Sub FormNozzleCam_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
        cam.Dispose()
    End Sub

    Private Sub FormNozzleCam_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        FormNozzleInspection.TextBox2.Text = Button1.Text
        FormNozzleInspection.PictureBox1.Image = PictureBox1.Image
        Me.Close()
    End Sub
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        FormNozzleInspection.TextBox2.Text = Button2.Text
        FormNozzleInspection.PictureBox1.Image = PictureBox1.Image
        Me.Close()
    End Sub
End Class