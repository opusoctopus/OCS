...
Public Class FormStencilEvidence1
    ...
    Private Sub Button_Save_Click(sender As Object, e As EventArgs) Handles Button_Save.Click
        ...
        FormStencilSelfCheckIncoming.Label27.Hide()
    End Sub

    Private Sub FormStencilEvidence1_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
        cam.Dispose()
    End Sub

    Private Sub FormStencilEvidence1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub cam_FrameSaved(capImage As Bitmap, imgPath As String) Handles cam.FrameSaved
        ...
        FormStencilSelfCheckIncoming.PictureBox2.Image = New Bitmap(capImage)
