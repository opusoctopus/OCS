...
Public Class FormStencilEvidence2
    ...
    Private Sub Button_Save_Click(sender As Object, e As EventArgs) Handles Button_Save.Click
        ...
        FormStencilSelfCheckIncoming.Label26.Hide()
    End Sub
    ...
    Private Sub cam_FrameSaved(capImage As Bitmap, imgPath As String) Handles cam.FrameSaved
        ...
        FormStencilSelfCheckIncoming.PictureBox3.Image = New Bitmap(capImage)
    ...
    Private Sub FormStencilEvidence2_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
        cam.Dispose()
    End Sub

    Private Sub FormStencilEvidence2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ComboBox_Devices.Items.AddRange(cam.GetCaptureDevices)
