...
Public Class FormRepairInspectionLQC
    ...
    Private Sub FormRepairInspectionLQC_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        ElseIf Label9.Text = "DONE" Then
            ...
            Dim Query As String
            Call connection()
            Query = "SELECT approved_lqc, before_inspect, after_inspect FROM prodsys2_repair_inspection_tbl WHERE txn_id = '" & Label8.Text & "'"
            ...
            While rd.Read()
                ...
                If rd.Item("approved_lqc") = "YES" Then
                    CheckBox1.Enabled = False
                    CheckBox2.Enabled = False
                    Button4.Enabled = False
                ElseIf rd.Item("approved_lqc") = "NO" Then
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        If CheckBox1.Checked = True Then
            sql = "UPDATE prodsys2_repair_inspection_tbl SET approved_lqc='" & CheckBox1.Text & "', approval_lqc='" & FormMain.LabelNama.Text & "' WHERE txn_id=" & Label8.Text
            saveData(sql)
            Call LoadData()
            Call LoadDataSum()
        ElseIf CheckBox2.Checked = True Then
            sql = "UPDATE prodsys2_repair_inspection_tbl SET approved_lqc='" & CheckBox2.Text & "', approval_lqc='" & FormMain.LabelNama.Text & "' WHERE txn_id=" & Label8.Text
            saveData(sql)
            Call LoadData()
            Call LoadDataSum()
        Else
